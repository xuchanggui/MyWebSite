...
function loginDialog(){
  var loginTpl = '<div class="title">登录<a class="shut-down-icon Js-pop-close"></a></div>\
                 <div class="logwrap clearfix">\
                 <form action="/login_form"   onsubmit="return validate_form();" wx-validator wx-validator-ajax name="loginForm" method="post" wx-validator-single-error="registerFormError">\
                 <div class="logleft"><span id="loginFormError" class="error-text"></span>\
                 <div class="shell clearfix"><input class="foc"  id="mobile" name="mobile" wx-validator-rule="required" wx-validator-username-required="*请输入账号" wx-validator-placeholder="用户名/手机号/邮箱" type="text" ></div>\
                 <div class="shell clearfix"><input type="password"  id="password" name="password" wx-validator-rule="required|rangelength" wx-validator-param="|6-16"  wx-validator-user_pwd-required="*请输入密码" wx-validator-placeholder="密码"></div>\
                 <div class="shell submitwrap clearfix"><button type="submit" class="zc" href="javascript:;">登录</button><a class="wjmm" href="/user-getpassword">忘记密码</a></div>\
                 </div>\
                 ...
                 <div class="icon clearfix shell"><a class="wb" href="https://api.weibo.com/oauth2/authorize?client_id=1494625316&redirect_uri=http%3A%2F%2Fwww.zhongchou.cn%2Fapi_callback.php%3Fc%3DSina%26response_type%3Dcode&response_type=code"></a><a class="qq" href="https://open.t.qq.com/cgi-bin/oauth2/authorize?client_id=801393846&redirect_uri=http%3A%2F%2Fwww.zhongchou.cn%2Fapi_callback.php%3Fc%3DTencent&response_type=code"></a></div>\
                 </div>\
                 </form>\
                 </div>'; 


  var mloginTpl = '<div class="title">登录<a class="shut-down-icon Js-pop-close"></a></div>\
                  <div class="logwrap clearfix">\
  ...
  var registerTpl = '<div class="title">注册<a class="shut-down-icon Js-pop-close"></a></div>\
                    ...
                    <div class="shell submitwrap clearfix"><a type="submit" class="zc" href="javascript:;">注册</a><span><input class="xy" name="article" checked="checked" wx-validator-article-nocheck="请阅读协议并勾选同意" type="checkbox"><label>阅读并同意</label><a target="_blank" href="/help-term">《服务协议》</a></span></div>\
                    </div>\
                    <div class="logright"><span class="error-text"></span>\
                ...
                success: function(data){
                  if(data.error){
                      ...
                      /* document.getElementById("mobile").value="";*/
                       ...
                       $("#loginFormError").text(data.error);
                       return false;
                  }else{
                    //alert(data.success);
                    //flag=flag+1;
